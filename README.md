...
![](https://github.com/KaranGoel1/twitter_postgres_parallel/workflows/tests_normalized/badge.svg)

![](https://github.com/KaranGoel1/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg)

![](https://github.com/KaranGoel1/twitter_postgres_parallel/workflows/tests_normalized_batch/badge.svg)

![](https://github.com/KaranGoel1/twitter_postgres_parallel/workflows/tests_normalized_batch_parallel/badge.svg)

![](https://github.com/KaranGoel1/twitter_postgres_parallel/workflows/tests_denormalized/badge.svg)

![](https://github.com/KaranGoel1/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg)
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 7m45.956s                          | 59.209s                          | 
| `pg_normalized_batch`  | 2m39.589s                          | 15.022s                          | 
| `pg_denormalized`      | 18.276s                          | 4.107s                          | 
